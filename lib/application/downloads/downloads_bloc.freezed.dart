...
mixin _$DownloadsState {
  ...
  Option<Either<MainFailure, List<Downloads>>> get downloadFailorSucces =>
      throw _privateConstructorUsedError;
...
abstract class $DownloadsStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Option<Either<MainFailure, List<Downloads>>> downloadFailorSucces});
}
...
class _$DownloadsStateCopyWithImpl<$Res, $Val extends DownloadsState>
  ...
  $Res call({
    ...
    Object? downloadFailorSucces = null,
  }) {
    return _then(_value.copyWith(
      ...
      downloads: null == downloads
          ...
          : downloads // ignore: cast_nullable_to_non_nullable
              as List<Downloads>,
      downloadFailorSucces: null == downloadFailorSucces
          ? _value.downloadFailorSucces
          : downloadFailorSucces // ignore: cast_nullable_to_non_nullable
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      required this.downloadFailorSucces})
  ...
  @override
  final Option<Either<MainFailure, List<Downloads>>> downloadFailorSucces;

  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downloads: $downloads, downloadFailorSucces: $downloadFailorSucces)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.downloadFailorSucces, downloadFailorSucces) ||
                other.downloadFailorSucces == downloadFailorSucces));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isLoading,
      const DeepCollectionEquality().hash(_downloads), downloadFailorSucces);
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final Option<Either<MainFailure, List<Downloads>>>
          downloadFailorSucces}) = _$_DownloadsState;
